...
@section('content')
  <div class="reset-pass-wrapper">
    <div class="reset-pass-content">
      ...
      <form id="reset-pass-form" method="POST" action="{{ route('change_password', ['token' => $token]) }}">
        @csrf
        <label for="password">Mật khẩu</label>
        <input type="password" id="password" name="password" placeholder="Nhập mật khẩu">

        <label for="confirm-password">Nhập lại mật khẩu</label>
        <input type="password" id="confirm-password" name="confirm_password" placeholder="Nhập mật khẩu">
